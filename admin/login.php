...
?>
    ...
    <head>
        ...
        <style>
            ...
            .gradient {
              background: linear-gradient(90deg, rgba(148,59,24,1) 0%, rgba(231,90,62,1) 0%, rgba(252,198,189,1) 100%);
            }
            .gradient .label-color {
              color: #fde4f5;
            }
            .gradient .label-color > span.text-danger {
              color: #a33126 !important;
            }
            p.lead {
              color: #000;
            }
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card o-hidden border-0 shadow-lg my-5 rounded">
                        <div class="card-body p-0 gradient">
                            <div class="row">
                                <div class="col-12">
                                    <div class="p-5">
                ...
                ?>
                    ...
                    <label for="username" class="form-label font-weight-bold label-color"> Username <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="username" id="username" placeholder="Enter username...">
                                            </div>
                                            <div class="form-group">
                    <label for="password" class="form-label font-weight-bold label-color"> Password <span class="text-danger">*</span></label>
